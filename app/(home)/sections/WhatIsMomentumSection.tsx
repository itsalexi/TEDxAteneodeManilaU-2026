    ...
    <section id="what-is-momentum" className="relative w-full bg-black overflow-hidden">
      ...
      <div className="relative z-10 py-14 sm:py-20 md:py-32 px-5 sm:px-6">
        <div className="mx-auto max-w-2xl flex flex-col gap-10 md:gap-16">
          ...
          <Reveal variant="zoom-in" delay={0.2} className="flex justify-center md:hidden">
            <WatchTrailerButton />
          </Reveal>
        </div>
      </div>
      ...
      <Reveal variant="zoom-in" delay={0.3} className="hidden md:flex absolute right-[19%] top-1/3 z-20">
        <WatchTrailerButton />
      </Reveal>
    </section>
  );
